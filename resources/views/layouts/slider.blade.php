                        ...
                        <div class="col-xl-10 px-0">
                            ...
                            >
                                <div class="carousel-inner">
                                    ...
                                    >
                                        <div
                                            class="row h-100 m-lg-7 mx-3 mt-6 mx-md-4 my-md-7"
                                        >
                                            <div class="col-md-4 mb-8 mb-md-0">
                                                <div
                                                    class="card card-span h-100 shadow-lg"
                                                >
                                                    ...
                                                    <div
                                                        class="card-body d-flex flex-column flex-center py-6"
                                                    >
                                                        <div class="my-4">
                                                            <ul
                                                        ...
                                                        <p
                                                            class="card-text text-center text-1000 px-4"
                                                        >
                                                            I love Jobest, easy
                                                            platform to
                                                            use,fantasic staff
