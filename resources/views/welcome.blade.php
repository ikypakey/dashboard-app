            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                         <!-- <a href=""> -->
                        <button class="btn-card" style="background-color: #EEEDED; color: #071952; ">
                            <img src="{{ asset('dashboard-assets/assets/img/icons/plan.png') }}" alt=""  style="height:90px; width: 95px; margin-top: -15px;"   />
                            Planning
                        </button>
                        <!-- </a> -->
                    </div>
                    ...
                    <div class="col-lg-3">
                        ...
                        <button class="btn-card" style="background-color: #EEEDED; color: #071952; margin: top 40px;">
                            <img src="{{ asset('dashboard-assets/assets/img/icons/debit.png') }}" alt="" style=" height:85px; width:95px; margin-top: 10px;"  />
                    ...
                    <div class="col-lg-3">
                        ...
                        <button class="btn-card" style="background-color: #EEEDED; color: #071952; margin: top 20px">
                            <img src="{{ asset('dashboard-assets/assets/img/icons/calendar2.png') }}" alt="" style="height: 85px; padding-top: 10px;"/>
                    ...
                    <div class="col-lg-3">
                        ...
                        <button class="btn-card" style="background-color: #EEEDED; color: #071952;">
                            <img src="{{ asset('dashboard-assets/assets/img/icons/whs.png') }}" alt="" style="width: 56;" />
                            WHS OT Report
                        </button>
